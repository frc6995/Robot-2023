...
// AHRSAndPositioningWithTimestampAndRaw Update Packet (similar to AHRSPosTS, but adds raw data)
    ...
    public final static byte MSGID_AHRSPOS_TS_RAW_UPDATE = 				'u';
    final static int AHRSPOS_TS_RAW_UPDATE_YAW_VALUE_INDEX =              4; /* Signed 16:16.  Signed Hundredths */
    final static int AHRSPOS_TS_RAW_UPDATE_ROLL_VALUE_INDEX =             8; /* Signed 16:16.  Signed Hundredths */
    final static int AHRSPOS_TS_RAW_UPDATE_PITCH_VALUE_INDEX =           12; /* Signed 16:16.  Signed Hundredeths */
    final static int AHRSPOS_TS_RAW_UPDATE_HEADING_VALUE_INDEX =         16; /* Signed 16:16.  Unsigned Hundredths */
    final static int AHRSPOS_TS_RAW_UPDATE_ALTITUDE_VALUE_INDEX =        20; /* Meters.   Signed 16:16 */
    final static int AHRSPOS_TS_RAW_UPDATE_FUSED_HEADING_VALUE_INDEX =   24; /* Degrees.  Unsigned Hundredths */
    final static int AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_X_VALUE_INDEX =  28; /* Inst. G.  Signed 16:16 */
    final static int AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_Y_VALUE_INDEX =  32; /* Inst. G.  Signed 16:16 */
    final static int AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_Z_VALUE_INDEX =  36; /* Inst. G.  Signed 16:16 */
    final static int AHRSPOS_TS_RAW_UPDATE_VEL_X_VALUE_INDEX =           40; /* Signed 16:16, in meters/sec */
    final static int AHRSPOS_TS_RAW_UPDATE_VEL_Y_VALUE_INDEX =           44; /* Signed 16:16, in meters/sec */
    final static int AHRSPOS_TS_RAW_UPDATE_VEL_Z_VALUE_INDEX =           48; /* Signed 16:16, in meters/sec */
    final static int AHRSPOS_TS_RAW_UPDATE_DISP_X_VALUE_INDEX =          52; /* Signed 16:16, in meters */
    final static int AHRSPOS_TS_RAW_UPDATE_DISP_Y_VALUE_INDEX =          56; /* Signed 16:16, in meters */
    final static int AHRSPOS_TS_RAW_UPDATE_DISP_Z_VALUE_INDEX =          60; /* Signed 16:16, in meters */
    final static int AHRSPOS_TS_RAW_UPDATE_QUAT_W_VALUE_INDEX =          64; /* Signed 16:16 */
    final static int AHRSPOS_TS_RAW_UPDATE_QUAT_X_VALUE_INDEX =          68; /* Signed 16:16 */
    final static int AHRSPOS_TS_RAW_UPDATE_QUAT_Y_VALUE_INDEX =          72; /* Signed 16:16 */
    final static int AHRSPOS_TS_RAW_UPDATE_QUAT_Z_VALUE_INDEX =          76; /* Signed 16:16 */
    final static int AHRSPOS_TS_RAW_UPDATE_MPU_TEMP_VAUE_INDEX =         80; /* Centigrade.  Signed Hundredths */
    final static int AHRSPOS_TS_RAW_UPDATE_OPSTATUS_VALUE_INDEX =        82; /* NAVX_OP_STATUS_XXX */
    final static int AHRSPOS_TS_RAW_UPDATE_SENSOR_STATUS_VALUE_INDEX =   83; /* NAVX_SENSOR_STATUS_XXX */
    final static int AHRSPOS_TS_RAW_UPDATE_CAL_STATUS_VALUE_INDEX =      84; /* NAVX_CAL_STATUS_XXX */
    final static int AHRSPOS_TS_RAW_UPDATE_SELFTEST_STATUS_VALUE_INDEX = 85; /* NAVX_SELFTEST_STATUS_XXX */
    final static int AHRSPOS_TS_RAW_UPDATE_TIMESTAMP_INDEX =		     86; /* UINT32 Timestamp, in milliseconds */
    final static int AHRSPOS_TS_RAW_UPDATE_GYRO_X_VALUE_INDEX =			 90; /* INT16, in device units (scaled by FSR) */
    final static int AHRSPOS_TS_RAW_UPDATE_GYRO_Y_VALUE_INDEX =			 92; /* INT16, in device units (scaled by FSR) */
    final static int AHRSPOS_TS_RAW_UPDATE_GYRO_Z_VALUE_INDEX =			 94; /* INT16, in device units (scaled by FSR) */
    final static int AHRSPOS_TS_RAW_UPDATE_ACC_X_VALUE_INDEX =			 96; /* INT16, in device units (scaled by FSR) */
    final static int AHRSPOS_TS_RAW_UPDATE_ACC_Y_VALUE_INDEX =			 98; /* INT16, in device units (scaled by FSR) */
    final static int AHRSPOS_TS_RAW_UPDATE_ACC_Z_VALUE_INDEX =			 100; /* INT16, in device units (scaled by FSR) */
	final static int AHRSPOS_TS_RAW_UPDATE_LAST_SAMPLE_DELTA_SEC_INDEX = 104; /* Signed 16:16 */
	final static int AHRSPOS_TS_RAW_UPDATE_GYRO_BIAS_UPDATED_BOOL_INDEX =108; /* INT16, 0 if false, otherwise true */
    final static int AHRSPOS_TS_RAW_UPDATE_MESSAGE_CHECKSUM_INDEX =      110;
    final static int AHRSPOS_TS_RAW_UPDATE_MESSAGE_TERMINATOR_INDEX =    112;
    final static int AHRSPOS_TS_RAW_UPDATE_MESSAGE_LENGTH =              114;	
    ...
    public final static int MAX_BINARY_MESSAGE_LENGTH = AHRSPOS_TS_RAW_UPDATE_MESSAGE_LENGTH;
    ...
    static public class AHRSPosTSRawUpdate extends AHRSPosTSUpdate {
        ...
        public boolean gyro_bias_updated;	// true if gyro bias was updated (e.g., when still) during last sample
    };
    ...
    public static int decodeAHRSPosTSRawUpdate( byte[] buffer, 
            int offset, 
            int length, 
            AHRSPosTSRawUpdate u) {
		if (length < AHRSPOS_TS_RAW_UPDATE_MESSAGE_LENGTH) {
			return 0;
		}
		int msg_len = (((int)buffer[offset+2]) & 0xFF); // Length is > 127, so treat as unsigned value
		if ( (buffer[offset+0] == PACKET_START_CHAR) && 
				(buffer[offset+1] == BINARY_PACKET_INDICATOR_CHAR) && 
			...
			u.pitch = decodeProtocol1616Float(buffer, offset+AHRSPOS_TS_RAW_UPDATE_ROLL_VALUE_INDEX); /* FIXME */
			u.roll = decodeProtocol1616Float(buffer, offset+AHRSPOS_TS_RAW_UPDATE_PITCH_VALUE_INDEX); /* FIXME */
			u.compass_heading = decodeProtocol1616Float(buffer, offset+AHRSPOS_TS_RAW_UPDATE_HEADING_VALUE_INDEX);
			u.altitude = decodeProtocol1616Float(buffer, offset+AHRSPOS_TS_RAW_UPDATE_ALTITUDE_VALUE_INDEX);
			u.fused_heading = decodeProtocol1616Float(buffer,offset+AHRSPOS_TS_RAW_UPDATE_FUSED_HEADING_VALUE_INDEX);
			u.linear_accel_x = decodeProtocol1616Float(buffer,offset+AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_X_VALUE_INDEX);
			u.linear_accel_y = decodeProtocol1616Float(buffer,offset+AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_Y_VALUE_INDEX);
			u.linear_accel_z = decodeProtocol1616Float(buffer,offset+AHRSPOS_TS_RAW_UPDATE_LINEAR_ACCEL_Z_VALUE_INDEX);
			...
			u.mpu_temp = decodeProtocolSignedHundredthsFloat(buffer, offset+AHRSPOS_TS_RAW_UPDATE_MPU_TEMP_VAUE_INDEX);
			/* AHRSPosTSUpdate:  Quaternions are 16.16 format (32-bit resolution). */
			u.quat_w = decodeProtocol1616Float(buffer,offset+AHRSPOS_TS_RAW_UPDATE_QUAT_W_VALUE_INDEX) / 16384.0f;
			u.quat_x = decodeProtocol1616Float(buffer,offset+AHRSPOS_TS_RAW_UPDATE_QUAT_X_VALUE_INDEX) / 16384.0f;
			u.quat_y = decodeProtocol1616Float(buffer,offset+AHRSPOS_TS_RAW_UPDATE_QUAT_Y_VALUE_INDEX) / 16384.0f;
			u.quat_z = decodeProtocol1616Float(buffer,offset+AHRSPOS_TS_RAW_UPDATE_QUAT_Z_VALUE_INDEX) / 16384.0f;
			...
			u.delta_t_sec = decodeProtocol1616Float(buffer,offset+AHRSPOS_TS_RAW_UPDATE_LAST_SAMPLE_DELTA_SEC_INDEX);
			u.gyro_bias_updated = ((decodeBinaryInt16(buffer,offset+AHRSPOS_TS_RAW_UPDATE_GYRO_BIAS_UPDATED_BOOL_INDEX) != 0) ? true : false);
    ...
    public static int decodeMagCalDataGetResponse( byte[] buffer, 
             ...
             ( buffer[offset+3] == MSGID_MAG_CAL_CMD ) )
        {
          ...
          for ( int i = 0; i < 3; i++ ) {
              for ( int j = 0; j < 3; j++ ) {
                  d.mag_xform[i][j] = decodeProtocol1616Float(buffer, offset+MAG_XFORM_1_1_VALUE_INDEX + (i * 6) + (j * 2));
              }
          }
          d.earth_mag_field_norm = decodeProtocol1616Float(buffer, offset+MAG_CAL_EARTH_MAG_FIELD_NORM_VALUE_INDEX);
          return MAG_CAL_CMD_MESSAGE_LENGTH;
        }
        return 0;
    }
    ...
    public static int decodeBoardIDGetResponse( byte[] buffer,
             ...
             ( buffer[offset+3] == MSGID_BOARD_IDENTITY_RESPONSE ) )
        {
            ...
            id.fw_revision = decodeBinaryUint16(buffer,offset+BOARD_IDENTITY_FW_VER_REVISION_VALUE_INDEX);
            for ( int i = 0; i < 12; i++ ) {
