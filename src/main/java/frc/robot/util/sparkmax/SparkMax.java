 ...
 */
 ...
 public class SparkMax extends CANSparkMax {
	 ...
	 /**
	  * Create a motor controller from a SparkMax object.
	  *
	  * @param sparkMax     A SparkMax object. Run any initialization that you
	  *                     want excluded from the
	  *                     built in health monitor functions
	  * @param initFunction A function which takes a SparkMax and returns a
	  *                     Boolean. This function
	  *                     is used to initialize the SparkMax device, and is
	 ...
	 /**
	  * Modify SparkMax object. Mutations using this method are re-run in order in
	  * the case of a
	  ...
	  *
	  * @param fcn a function on the underlying SparkMax object returning true on
	  *            success. Typically
	  ...
	  *
	  * @param sparkMax     SparkMax object to run this on
