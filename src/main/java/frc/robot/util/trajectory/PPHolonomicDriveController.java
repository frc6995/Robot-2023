...
public class PPHolonomicDriveController {
  ...
  public ChassisSpeeds calculate(Pose2d currentPose, PathPlannerState referenceState) {
    ...
    double xAccel =
        referenceState.accelerationMetersPerSecondSq * referenceState.poseMeters.getRotation().getCos();
    double yAccel =
        referenceState.accelerationMetersPerSecondSq * referenceState.poseMeters.getRotation().getSin();
