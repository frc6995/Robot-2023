...
public class ProfiledPIDController implements Sendable {
  ...
  private TrapezoidProfile.State m_nextSetpoint = new TrapezoidProfile.State();
  ...
  /**
   * Returns the next setpoint of the ProfiledPIDController, useful for acceleration feedforward.
   * @return The next setpoint
   */
  public TrapezoidProfile.State getNextSetpoint() {
    return m_nextSetpoint;
  }
  ...
  public double calculate(double measurement) {
    ...
    m_nextSetpoint = profile.calculate(getPeriod() * 2.0);
