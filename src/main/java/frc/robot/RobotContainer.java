...
public class RobotContainer implements Logged{
    ...
    public void addAutoRoutines() {
        ...
        m_autoSelector.addOption("2.5pc Bump Climb", m_autos.highConeHighCubeBumpSide().andThen(m_autos.cubePickupClimbBumpAddon()));
    ...
    public void periodic() {
        ...
        LightStripS.getInstance().requestState(m_autos.isCubeSelected() ? States.RequestingCube : States.RequestingCone);
